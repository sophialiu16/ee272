...
directive set /InputDoubleBuffer<512,16,16>/InputDoubleBufferReader<512,16,16>/run/while:tmp.data.value -WORD_WIDTH 128
directive set /InputDoubleBuffer<512,16,16>/InputDoubleBufferWriter<512,16,16>/run/while:tmp.data.value -WORD_WIDTH 128
# -------------------------------
# Your code ends here
# -------------------------------
