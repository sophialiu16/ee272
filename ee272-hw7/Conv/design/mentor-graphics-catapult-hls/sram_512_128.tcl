...
OUTPUT_DIR       ./memory
FILES {
  { FILENAME ./inputs/sram_512_128.v               FILETYPE Verilog MODELTYPE generic   PARSE 1 PATHTYPE copy STATICFILE 1 VHDL_LIB_MAPS work }
}
VHDLARRAYPATH    {}
WRITEDELAY       0.1
INITDELAY        1
...
PARAMETERS {
 ...
 { PARAMETER ADDR_WIDTH		TYPE hdl	IGNORE 0	MIN {} MAX {} DEFAULT 9 }
