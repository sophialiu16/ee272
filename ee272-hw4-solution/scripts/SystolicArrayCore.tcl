...
# -------------------------------
directive set /SystolicArrayCore<IDTYPE,WDTYPE,ODTYPE,16,16>/run/accumulation_buffer:rsc -INTERLEAVE 16
directive set /SystolicArrayCore<IDTYPE,WDTYPE,ODTYPE,16,16>/run/accumulation_buffer:rsc -BLOCK_SIZE 256
# -------------------------------
# Your code ends here
# -------------------------------
