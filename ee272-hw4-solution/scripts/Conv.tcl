...
solution library add {[Block] WeightDoubleBuffer<384,16,16>.v1}
...
directive set /Conv/WeightDoubleBuffer<384,16,16> -MAP_TO_MODULE {[Block] WeightDoubleBuffer<384,16,16>.v1}
