#ifndef __INCLUDED_sram_512_128_trans_rsc_H__
#define __INCLUDED_sram_512_128_trans_rsc_H__
...
>
class sram_512_128_trans_rsc : public mc_wire_trans_rsc_base<128,4096>
{
public:
  sc_in< bool >   clk;
  sc_in< sc_logic >   csb;
  ...
  SC_HAS_PROCESS( sram_512_128_trans_rsc );
  sram_512_128_trans_rsc(const sc_module_name& name, bool phase, double clk_skew_delay=0.0)
  ...
  virtual void start_of_simulation() {
    ...
    if (base::_holdtime > 0) {
      ...
      msg << "sram_512_128_trans_rsc CLASS_STARTUP - CLK_SKEW_DELAY = "
...
#endif // ifndef __INCLUDED_sram_512_128_trans_rsc_H__
