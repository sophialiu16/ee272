#ifndef __INCLUDED_sram_384_128_trans_rsc_H__
#define __INCLUDED_sram_384_128_trans_rsc_H__
...
>
class sram_384_128_trans_rsc : public mc_wire_trans_rsc_base<128,49152>
{
public:
  sc_in< bool >   clk;
  sc_in< sc_logic >   csb;
  ...
  typedef mc_wire_trans_rsc_base<128,49152> base;
  MC_EXPOSE_NAMES_OF_BASE(base);

  SC_HAS_PROCESS( sram_384_128_trans_rsc );
  sram_384_128_trans_rsc(const sc_module_name& name, bool phase, double clk_skew_delay=0.0)
  ...
  virtual void start_of_simulation() {
    ...
    if (base::_holdtime > 0) {
      ...
      msg << "sram_384_128_trans_rsc CLASS_STARTUP - CLK_SKEW_DELAY = "
...
private:
  ...
  int get_addr(const sc_lv<WRAPPER_ADDR_BITS>& addr, const char* pin_name) {
    if (addr.is_01()) {
      ...
      if (cur_addr < 0 || cur_addr >= 49152) {
#ifdef CCS_SYSC_DEBUG
        std::ostringstream msg;
        msg << "Invalid address '" << cur_addr << "' out of range [0:" << 49152-1 << "]";
...
#endif // ifndef __INCLUDED_sram_384_128_trans_rsc_H__
