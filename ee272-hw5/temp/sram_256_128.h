#ifndef __INCLUDED_sram_256_128_H__
#define __INCLUDED_sram_256_128_H__

// SystemC memory model of sram_256_128
// Generated by Catapult memory generator
// Generated by:   sophliu
// Generated date: Tue Feb 25 18:50:24 2020

// The following classes have been defined:
//     class sram_256_128 a 0 delay "structural" model of the RAM

//     class sram_256_128_model<TLM/SYN>::mem<T,size,TLM/SYN>
//         A memory model that can be instanced and used for simulation and synthesis

//     class sram_256_128_model<TLM/SYN>::port_0_port<T,size,TLM/SYN>
...
#pragma map_to_operator sram_256_128
template <
  int ram_id,
  int WRAPPER_WIDTH,
  int WRAPPER_ADDR_BITS>
class sram_256_128 : public sc_module
{
public:
  sc_in< bool >   clk;
  sc_in< bool >   csb;
  ...
  sc_signal<sc_lv<128> > mem[32768];
#endif

  SC_CTOR(sram_256_128) :
    clk("clk")
    ,csb("csb")
    ,web("web")
    ,addr("addr")
  ...
  void seq_proc_1() {
    ...
    if ((csb==0) && (web==0)) {
      ...
      assert( address>=0 && address <32768 );
#endif
...
public:
  ...
  private:
    sram_256_128<0, data_width, addr_width> RAM;
  };
...
#endif // ifndef __INCLUDED_sram_256_128_H__
