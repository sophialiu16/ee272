...
export construct_path=/home/users/skavya/ee272/ee272-hw5/GcdUnit/design/construct.py
...
echo
echo "Constructed from -- /home/users/skavya/ee272/ee272-hw5/GcdUnit/design/construct.py"
echo
)
